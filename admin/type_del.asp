...
<form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1" id="form1" >
  <table width="400" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
    <tr>
      <td height="30" colspan="2" bgcolor="#CCCCCC" class="STYLE2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp; 管理员！你确定要删除此新闻分类吗？</td>
    </tr>
    <tr>
      <td width="94" height="25"> 新闻分类名称：</td>
      <td width="306"><input value="<%=((Recordset1.Fields.Item("type_name").Value))%>" name="type_name" type="text" id="type_name" /></td>
    </tr>
    <tr>
      <td height="25" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
          <input type="submit" name="Submit" value="删除" />
          <input name="Submit2" type="submit" value="取消" /></td>
    </tr>
  </table>
