...
Recordset1_cmd.CommandText = "SELECT * FROM news WHERE news_id = ?" 
...
%>
  ...
  <tr>
    ...
    <td width="778" height="428" background="images/images_05.gif" valign="top"><table width="83%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="30" align="center"><strong class="title"><%=(Recordset1.Fields.Item("news_title").Value)%></strong></td>
        </tr>
      <tr>
        <td><%=(Recordset1.Fields.Item("news_content").Value)%></td>
        </tr>
    </table></td>
  </tr>
  <tr>
    <td colspan="2"><div style="background-color: #0066CC;height:25px;line-height:25px;"><font color="white">&nbsp;@版权所有</font><font color="white" style="float:right">关于我们&nbsp; | 网络广告 &nbsp;|技术支持&nbsp;</font></div></td>
  </tr>
</table>
</body>
</html>
